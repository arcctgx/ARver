...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__minicdio

#else
#  define SWIG_init    init_minicdio

#endif
#define SWIG_name    "_minicdio"
...
# endif
  ...
  SWIG_Python_SetConstant(d, "DRIVER_UNKNOWN",SWIG_From_long((long)(DRIVER_UNKNOWN)));
  SWIG_Python_SetConstant(d, "DRIVER_DEVICE",SWIG_From_long((long)(DRIVER_DEVICE)));
  SWIG_Python_SetConstant(d, "DRIVER_OP_SUCCESS",SWIG_From_long((long)(DRIVER_OP_SUCCESS)));
  SWIG_Python_SetConstant(d, "DRIVER_OP_ERROR",SWIG_From_long((long)(DRIVER_OP_ERROR)));
  SWIG_Python_SetConstant(d, "DRIVER_OP_UNSUPPORTED",SWIG_From_long((long)(DRIVER_OP_UNSUPPORTED)));
  SWIG_Python_SetConstant(d, "DRIVER_OP_UNINIT",SWIG_From_long((long)(DRIVER_OP_UNINIT)));
  SWIG_Python_SetConstant(d, "DRIVER_OP_NOT_PERMITTED",SWIG_From_long((long)(DRIVER_OP_NOT_PERMITTED)));
  SWIG_Python_SetConstant(d, "DRIVER_OP_BAD_PARAMETER",SWIG_From_long((long)(DRIVER_OP_BAD_PARAMETER)));
  SWIG_Python_SetConstant(d, "DRIVER_OP_BAD_POINTER",SWIG_From_long((long)(DRIVER_OP_BAD_POINTER)));
  SWIG_Python_SetConstant(d, "DRIVER_OP_NO_DRIVER",SWIG_From_long((long)(DRIVER_OP_NO_DRIVER)));
  SWIG_Python_SetConstant(d, "CDROM_LEADOUT_TRACK",SWIG_From_long((long)(CDIO_CDROM_LEADOUT_TRACK)));
  SWIG_Python_SetConstant(d, "INVALID_TRACK",SWIG_From_long((long)(CDIO_INVALID_TRACK)));
  SWIG_Python_SetConstant(d, "INVALID_LBA",SWIG_From_long((long)(CDIO_INVALID_LBA)));
  SWIG_Python_SetConstant(d, "INVALID_LSN",SWIG_From_long((long)(CDIO_INVALID_LSN)));
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
